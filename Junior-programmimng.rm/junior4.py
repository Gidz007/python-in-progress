...
class Animal:
    ...
    # The init fuction is called upon when ever you a trying to create a new object.
...
# Here the class dog is inheriting properties and mehtods for the class animal.
class Dog(Animal):
...
class Bull_dog(Dog):
    # The class Bull dog has three methods which is sound and the inherited methos which is details from the Animal class.
    def greets(self):
        print("dog sooofs")
